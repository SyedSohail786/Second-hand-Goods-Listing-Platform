...
import { FiEdit2, FiTrash2, FiImage, FiUpload, FiDollarSign, FiCalendar, 
         FiPhone, FiMapPin, FiBox, FiX, FiArrowLeft } from 'react-icons/fi';
...
const EditProduct = () => {
    ...
    const removeExistingImage = async (imagePath) => {
        if (window.confirm('Are you sure you want to remove this image?')) {
            try {
                await axios.delete(`http://localhost:5000/api/products/${id}/images`, {
                    headers: {
